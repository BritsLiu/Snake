...
def main():
    ...
    pygame.display.set_caption('Snake_2019_3_24')
...
def runGame():
    ...
    while True:  # main game loop
        ...
        if wormCoords[HEAD]['x'] == -1 or wormCoords[HEAD][
                'x'] == Cell_W or wormCoords[HEAD]['y'] == -1 or wormCoords[
                    HEAD]['y'] == Cell_H:
            return  # game over
        ...
        if wormCoords[HEAD]['x'] == apple['x'] and wormCoords[HEAD][
                'y'] == apple['y']:
...
def showGameOverScreen():
    ...
    gameSurf = gameOverFont.render('Liu Xin', True, YELLOW)
    overSurf = gameOverFont.render('You are GG!', True, White)
